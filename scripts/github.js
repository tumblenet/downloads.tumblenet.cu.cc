jQuery.fn.loadRepositories = function(username) {
    this.html("<span>API rate limit exceeded. (But here's the good news: Authenticated requests get a higher rate limit. <a href='https://developer.github.com/v3/#rate-limiting'>Check out the documentation for more details.</a>)</span><br><span>Normal Users: we are sorry that we cannot connect to githubs servers to get the information. <a href='http://github.com/" + username + "'>Click here to see them directly on GitHub's Servers.</a></span>");
